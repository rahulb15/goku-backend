(namespace "free")
(define-keyset "free.dbpolicy-ks-two" (read-keyset "dbpolicy-ks-two"))

(module dbpolicytest2 COOPER

  (defcap COOPER ()
    (enforce-guard (keyset-ref-guard "free.dbpolicy-ks-two")))
    ...
    (defun enforce-ledger:bool ()
      (enforce-guard (dbcontracttest2.ledger-guard))
    )
    ...
    (defun initialize (
      ...
      name:string
      fungible:module{fungible-v2})
      (coin.create-account "dbtestacc2" (read-keyset "dbpolicy-ks-two") )
