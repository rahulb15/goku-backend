(namespace "free")
(define-keyset "free.dbpolicy-ks-three" (read-keyset "dbpolicy-ks-three"))

(module dbpolicytest3 COOPER

  (defcap COOPER ()
    (enforce-guard (keyset-ref-guard "free.dbpolicy-ks-three")))
    ...
    (defun enforce-ledger:bool ()
      (enforce-guard (dbcontracttest3.ledger-guard))
    )
    ...
    (defun initialize (
      ...
      name:string
      fungible:module{fungible-v2})
      (coin.create-account "dbtestacc3" (read-keyset "dbpolicy-ks-three") )
