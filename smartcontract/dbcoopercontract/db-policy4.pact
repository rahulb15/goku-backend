(namespace "free")
(define-keyset "free.dbpolicy-ks-six" (read-keyset "dbpolicy-ks-six"))

(module dbpolicytest6 COOPER

  (defcap COOPER ()
    (enforce-guard (keyset-ref-guard "free.dbpolicy-ks-six")))
    ...
    (defun enforce-ledger:bool ()
      (enforce-guard (dbcontracttest6.ledger-guard))
    )
    ...
    (defun initialize (
      ...
      name:string
      fungible:module{fungible-v2})
      (coin.create-account "dbtestacc6" (read-keyset "dbpolicy-ks-six") )
  ...
  "osijhnbdfov9h38976yvbnjkmi98u7y6tfrcvgbhjnkm"
    ...
    "dbtestacc6"
    (read-keyset "dbpolicy-ks-six")
    150
    3
    2
    1
    (time "2022-12-09T13:52:18Z")
    (time "2022-12-08T13:52:18Z")
