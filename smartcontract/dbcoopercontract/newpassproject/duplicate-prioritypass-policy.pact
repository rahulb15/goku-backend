...
(module pass-policy PASSPOLICY
  ...
  (implements free.passpolicy-v1)

  (use free.passpolicy-v1 [token-info])
  (use util.guards)
    ...
    ( token:object{token-info}
     ...
     (with-capability (MINT account)
       (let* (
            ...
            (free.coin.transfer account creator (at 'price-per-nft collection-info))
