(namespace "free")
(define-keyset "free.dummydbnine-policy-ks" (read-keyset "dummydbnine-policy-ks"))

(module dummydbpolicynine COPPER

  (defcap COPPER ()
    (enforce-guard (keyset-ref-guard "free.dummydbnine-policy-ks")))
    ;(enforce-keyset "free.dummydbnine-policy-ks"))
    ...
    (defun enforce-ledger:bool ()
      (enforce-guard (dummytwo-db.ledger-guard))
    )
    ...
    (defun initialize (
      ...
      name:string
      fungible:module{fungible-v2})
      (coin.create-account "dbdemoeightaccount" (read-keyset "dummydbnine-policy-ks") )
  ...
  (create-table quotes)
  (free.dummydbpolicynine.initialize "dkasnckea"
   ...
   "e09f83gvwhsdcjizlknxvwservjzidm",
    ...
    "aop8efg9oancmpahi3b"]
  "dbdemoeightaccount"
  (read-keyset "dummydbnine-policy-ks")
  14
  10
  10
  1
  ...
  ; (free.dummydbpolicynine.initialize
  ;   "dkasnckea"
