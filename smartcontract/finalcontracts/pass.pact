(namespace 'free)
(define-keyset "free.passfinalks001" (read-keyset "passfinalks001"))

(module passfinal001 PASS
    ...
    (defcap PASS ()
     (enforce-guard (keyset-ref-guard "free.passfinalks001")))
    ...
    (defschema token-schema
     ...
     ; ============================================
      ...
      (defun create-collection:bool
          ...
          (with-read collections_table name
            ...
            (enforce-one "Only Admin or Collection creator can create tokens_table"
              [(enforce-guard collection-guard)
               (enforce-guard (keyset-ref-guard "passfinalks001"))])
          )
        )
        ...
        ; ==           FOR TOKEN-ID                 ==
        ; ============================================
; :https://gateway.pinata.cloud/ipfs/token0
;; https://gateway.pinata.cloud/ipfs/kajbduifnelsnCoishzeJSNCodz=zc
