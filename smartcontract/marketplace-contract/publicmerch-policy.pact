(namespace "free")
(define-keyset "free.merchpolicythree-admin-ks" (read-keyset "merchpolicythree-admin-ks"))
(module demomerchpolicycontractthree MERCH

  @doc "Policy for fixed issuance with royalty and quoted sale in specified fungible."

  (defcap MERCH ()
    (enforce-guard (keyset-ref-guard "free.merchpolicythree-admin-ks")))
  ...
  (defun initialize (
    ...
    name:string
    fungible:module{fungible-v2})
    (coin.create-account "merchcreatorthree" (read-keyset "merchpolicythree-admin-ks"))
    (coin.create-account "royaltyreceiveraccountthree" (read-keyset "merchpolicythree-admin-ks"))
...
(free.demomerchpolicycontractthree.initialize
"asjnasf"
...
"merchcreatorthree"
(read-keyset "merchpolicythree-admin-ks")
6
2
1
1
