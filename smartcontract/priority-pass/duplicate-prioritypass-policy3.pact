(namespace "free")
(define-keyset "free.policytestthree-ks" (read-keyset "policytestthree-ks"))
(module policytest4 DUMMPPOLICY

    @doc "Policy for fixed issuance with royalty and quoted sale in specified fungible."

    (defcap DUMMPPOLICY ()
      (enforce-guard (keyset-ref-guard "policytestthree-ks" )))
  ...
  ;  (deftable whitelists:{whitelist-schema})
    ...
    (defun enforce-ledger:bool ()
      (enforce-guard (passtest4.ledger-guard))
    )
...
(with-read mint-status MINT_STATUS
   ...
   ; )
    ...
    (defun initialize (
      ...
      fungible:module{fungible-v2}
       ...
       (coin.create-account "demobankacc5" (read-keyset "policytestthree-ks") )
  ...
  (free.policytest4.initialize "dkasnckea"
   ...
   "e09f83gvwhsdcjizlknxvwservjzidm",
    ...
    "aop8efg9oancmpahi3b"]
  "demobankacc5"
  (read-keyset "policytestthree-ks")
  14
  1
  2.0
  "PASS"
