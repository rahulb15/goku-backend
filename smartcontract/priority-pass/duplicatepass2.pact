(namespace 'free)
(define-keyset "free.padmin-ten-ks" (read-keyset "padmin-ten-ks"))

(module passtest10 MERCH
    ...
    (defcap MERCH ()
      (enforce-guard (keyset-ref-guard "free.padmin-ten-ks")))
          ...
          (with-read collections_table name
            ...
            (enforce-one "Only Admin or Collection creator can create tokens_table"
              [(enforce-guard collection-guard)
               (enforce-guard (keyset-ref-guard "padmin-ten-ks"))])
          )
        )
