...
const CONTRACT_PATH = '/Users/shubhamarya/Desktop/Flexsin/main_files/priority-pass/duplicatepass2.pact';
...
async function deployContract(pactCode) {
  const cmd = {
    ...
    pactCode: pactCode,
    envData: {
      // 'dum-pass-five-ks': [KEY_PAIR['publicKey']]
      'padmin-ten-ks': [KEY_PAIR['publicKey']]
